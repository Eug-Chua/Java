...
public class PhysicalProduct extends Product {
  ...
  public PhysicalProduct(String name, double price, String sku, String size, double weight, String color, int quantity) {
    super(name, price, sku, quantity); // calls the parent constructor
    this.size = size;
    this.weight = weight;
    this.color = color;
  }
